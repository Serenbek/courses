    ...
    <div className={scss.wrapper_box}>
        <div className={scss.wrapper}>
            <div className={scss.left}>
                ...
                <Typography variant="subtitle1" component="p">Since wire-frame renderings are relatively simple and fast to calculate, they are often used in cases</Typography>
            ...
            <div className={scss.right}>
                <div className={scss.box_wrapper}>
                    <div className={scss.box}>
                        ...
                        <Typography variant="subtitle1" component="p">28,965,389 students</Typography>
                    </div>
                    <div className={scss.box}>
                    ...
                    <div className={scss.box_web}>
                        <Typography variant="h6">{t("featured.webDevelopment")}</Typography>
                        <Typography variant="subtitle1" component="p">28,965,389 students</Typography>
                    </div>
                    <div className={scss.box}>
                    ...
                    <div className={scss.box_machine}>
                        <Typography variant="h6">{t("featured.machineLearning")}</Typography>
                        <Typography variant="subtitle1" component="p">28,965,389 students</Typography>
                    </div>
                    <div className={scss.box}>
                        <Typography variant="h6">{t("featured.cyberSecurity")}</Typography>
                        <Typography variant="subtitle1" component="p">28,965,389 students</Typography>
                    </div>
                    <div className={scss.box}>
